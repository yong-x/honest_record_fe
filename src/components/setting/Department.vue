	...
	<div>
		...
		@close="resetForm('addFormRef')">
			<el-form :model="addForm" :rules="addAndEditFormRules" ref="addFormRef">
				<el-form-item label="部门名称" prop="dName" :label-width="labelWidth">
					<el-input v-model="addForm.dName" clearable></el-input>
				</el-form-item>
				<el-form-item label="联系电话" prop="dPhone" :label-width="labelWidth">
					<el-input v-model="addForm.dPhone" clearable></el-input>
				</el-form-item>
				<el-form-item label="联系地址" prop="dAddress" :label-width="labelWidth">
					<el-input v-model="addForm.dAddress" clearable></el-input>
				</el-form-item>
			</el-form>
		...
		@close="resetForm('editFormRef')">
			<el-form :model="editForm" :rules="addAndEditFormRules" ref="editFormRef">
				<el-form-item label="部门名称" prop="dName" :label-width="labelWidth">
					<el-input v-model="editForm.dName" clearable></el-input>
				</el-form-item>
				<el-form-item label="联系电话" prop="dPhone" :label-width="labelWidth">
					<el-input v-model="editForm.dPhone" clearable></el-input>
				</el-form-item>
				<el-form-item label="联系地址" prop="dAddress" :label-width="labelWidth">
					<el-input v-model="editForm.dAddress" clearable></el-input>
				</el-form-item>
			</el-form>
			<div slot="footer" class="dialog-footer">
	...
	export default {
		...
		methods:{
			async doSearch(){
				...
				const {data: res} = await this.$http.get(`/department/query`,{params: this.queryInfo});
				console.log('res=>',res)
				if(res.code===0){
